...
import br.com.rfloja.model.FabricanteTableModel;
 ...
 */
public class FabricanteView extends javax.swing.JInternalFrame {
    ...
    public FabricanteView() {
        initComponents();
        jTableFabricante.setModel(tableModel);
        preencheTabela();
    ...
    FabricanteTableModel tableModel = new FabricanteTableModel();
    ...
    public void preencheTabela() {
        ...
        for (Fabricante fab : fabCtrl.readFabricante()) {
            tableModel.addRow(fab);
        }
        jTableFabricante.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        TableColumnAdjuster tca = new TableColumnAdjuster(jTableFabricante);
        tca.adjustColumns();

    }

    public JTextField[] limparCampos() {
        JTextField[] campos = {jTextFieldFabricante, jTextFieldObs, jTextFieldCod};
    ...
    public boolean verificaCamposEmBranco() {
        ...
        String cepvazio = "     -   ";
        String telvazio = "(  )       -     ";
        JTextField[] campos = {jTextFieldFabricante, jTextFieldObs};
        String[] camposNome = {"Fabricante", "Obs"};
        for (int i = 0; i < campos.length; i++) {
    ...
    private void habilitaCampos(boolean estado) {
        ...
        jTextFieldFabricante.setEnabled(estado);
    ...
    private void initComponents() {
        ...
        jTextFieldFabricante.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextFieldFabricanteFocusLost(evt);
            }
        });
            ...
            .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDadosFabricantesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldFabricante, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
        ...
        jTableFabricante.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableFabricanteMouseClicked(evt);
            }
        ...
        jScrollPane2.setViewportView(jTableFabricante);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        fabricante.setFabricante(jTextFieldFabricante.getText());
        fabricante.setObs(jTextFieldObs.getText());
        if (fabCtrl.createFabricante(fabricante)) {
    ...
    private void jTableFabricanteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableFabricanteMouseClicked
        // TODO add your handling code here:
        if (jTableFabricante.getSelectedRow() != -1) {
            jTextFieldCod.setText(jTableFabricante.getValueAt(jTableFabricante.getSelectedRow(), 0).toString());
            jTextFieldFabricante.setText(jTableFabricante.getValueAt(jTableFabricante.getSelectedRow(), 1).toString());
            jTextFieldObs.setText(jTableFabricante.getValueAt(jTableFabricante.getSelectedRow(), 2).toString());
        }
    }//GEN-LAST:event_jTableFabricanteMouseClicked
    ...
    private void jTextFieldFabricanteFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldFabricanteFocusLost
        // TODO add your handling code here:


    }//GEN-LAST:event_jTextFieldFabricanteFocusLost
