...
public class ImpressoraView extends javax.swing.JInternalFrame {
    ...
    public JTextField[] limparCampos() {
        JTextField[] campos = {jTextFieldImpressora, jTextFieldObs, jTextFieldCod};
    ...
    public boolean verificaCamposEmBranco() {
        ...
        String cepvazio = "     -   ";
        String telvazio = "(  )       -     ";
        JTextField[] campos = {jTextFieldImpressora, jTextFieldObs};
    ...
    private void habilitaCampos(boolean estado) {
        ...
        jTextFieldImpressora.setEnabled(estado);
    ...
    private void initComponents() {
        ...
        jTextFieldImpressora = new javax.swing.JTextField();
        ...
        jTextFieldImpressora.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextFieldImpressoraFocusLost(evt);
            }
        });
            ...
            .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDadosFabricantesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldImpressora, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
        ...
        jPanelDadosFabricantesLayout.setVerticalGroup(
            ...
            .addGroup(jPanelDadosFabricantesLayout.createSequentialGroup()
                ...
                .addGroup(jPanelDadosFabricantesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabelCPF)
                    .addComponent(jTextFieldImpressora, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanelDadosFabricantesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelNome)
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if (jTableImpressora.getSelectedRow() != -1) {
            ...
            impressora.setImpressora(jTextFieldImpressora.getText());
            impressora.setObs(jTextFieldObs.getText());
    ...
    private void jTableImpressoraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableImpressoraMouseClicked
        ...
        if (jTableImpressora.getSelectedRow() != -1) {
            ...
            jTextFieldImpressora.setText(jTableImpressora.getValueAt(jTableImpressora.getSelectedRow(), 1).toString());
            jTextFieldObs.setText(jTableImpressora.getValueAt(jTableImpressora.getSelectedRow(), 2).toString());
        }
    ...
    private void jTextFieldImpressoraFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldImpressoraFocusLost
        // TODO add your handling code here:


    }//GEN-LAST:event_jTextFieldImpressoraFocusLost
    ...
    private javax.swing.JTextField jTextFieldImpressora;
